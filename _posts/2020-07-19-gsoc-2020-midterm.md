...
Based on these preliminare studies and by integrating with the products of other research groups such as "EdibleFlora" and "SimpleFarming", for instance by adding events, the next stage of the project could commence.

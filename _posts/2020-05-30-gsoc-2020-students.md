...
description: >
  5th year anniversary for Terasology participating in Google Summer of Code :tada: 
...
This year is the 5th year anniversary for Terasology participating in the Google Summer of Code (GSOC) :tada:
...
Actually, that's incorrect... we have _two_ modules for that - which is a common situation (read: issue) to be honest :sweat_smile:
